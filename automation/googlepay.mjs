...
(async () => {
  ...
  // Import cookies
  const cookies = JSON.parse(fs.readFileSync('C:/Users/bendo/Desktop/Documents/HiringFunnel/TrelloJoin/trello-join/cookies/googlepay.json', 'utf8'));
  await page.setCookie(...cookies);

  // Navigate to the Google Pay page
  await page.goto('https://wallet.google.com/wallet/u/3/paymentmethods');
